...
<x-app-layout id='post-page'>
    ...
    <div class="border-b-2 border-gray-600 mt-4 p-4">
        ...
        <div class="mt-2 w-full flex flex-row">
            <div id="like-button" class="w-1/2 my-1 mx-2 p-2 cursor-pointer bg-blue-100 inline-block rounded-xl align-right hover:bg-gray-100 flex flex-row sm:w-[12%]">
                ...
                <span id="like-number" class="text-right w-4/5">  </span>
            </div>
            <div id="dislike-button" class="w-1/2 my-1 mx-2 p-2 cursor-pointer bg-blue-100 inline-block rounded-xl align-right hover:bg-gray-100 flex flex-row sm:w-[12%]">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <span id="dislike-number" class="text-right w-4/5">  </span>
            </div>
        </div>
    </div>
