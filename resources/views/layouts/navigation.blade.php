        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        @auth
                            <x-dropdown-link :href="route('userpage.show', Auth::user()->name)">
                                {{ __('User page') }}
                            </x-dropdown-link>
            ...
            @if(Auth::check() && Auth::user()->hasVerifiedEmail())
                <div class="hidden space-x-8 sm:-my-px sm:flex">
                    <x-nav-link :href="route('notification.show')" :active="request()->routeIs('notification.show')" aria-label="menu" title="menu">
    ...
    <div id="navbar-responsive-menu" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                @auth    
                    <x-responsive-nav-link :href="route('userpage.show', Auth::user()->name)">
                        {{ __('User page') }}
                    </x-responsive-nav-link>
